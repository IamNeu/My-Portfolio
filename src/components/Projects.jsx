...
const projects = [
  ...
  },
  {
    ...
    featured: true, // 👈 tag this project for special styling
  },
  {
    title: "Calculator",
  ...
  return (
    ...
    >
      ...
      <motion.h2
        ...
        className="text-4xl sm:text-3xl font-bold mb-12 bg-gradient-to-r from-teal-400 via-purple-400 to-teal-400 bg-clip-text text-transparent"
      >
        Projects
      </motion.h2>
        ...
        {projects.map((p, i) => (
          <motion.div
            ...
            className={`p-6 rounded-2xl shadow-lg transition-transform hover:scale-[1.02] 
              ${
                p.featured
                  ? // ✨ soft teal–purple–teal glow for your portfolio
          ...
          >
            ...
            <p className="text-gray-400 text-sm font-normal leading-relaxed mb-4">
              {p.desc}
            </p>
